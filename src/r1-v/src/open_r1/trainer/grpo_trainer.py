...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def __init__(
        ...
        self.beta = args.beta
        # print("******************** GRPOTrainer ****************************")
        # print('temperature:', self.generation_config.temperature)
        # print("******************** GRPOTrainer ****************************")
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        # modified  the self-plan mode aguvis
        # recipient_text = "<|im_start|>assistant<|recipient|>"
        # prompts_text = [prompt for prompt in prompts_text]
        ...
        with unwrap_model_for_generation(model, self.accelerator) as unwrapped_model:
            # print('before', self.generation_config)
            prompt_completion_ids = unwrapped_model.generate(**prompt_inputs, generation_config=self.generation_config)
            # print('after', self.generation_config)
        ...
        ## 현재 모델이 각 토큰을 뽑을 때의 log 확률 : 학습 대상
